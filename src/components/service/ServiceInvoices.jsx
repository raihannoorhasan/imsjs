    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Service Invoices</h2>
            <p className="text-gray-600 mt-1">Manage and track service billing and payments</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <SearchInput
            ...
            placeholder="Search invoices, customers, tickets..."
            className="w-full"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="p-6 bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-emerald-700">Paid Invoices</p>
              <p className="text-3xl font-bold text-emerald-900">{paidInvoices}</p>
            </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-orange-900">{pendingInvoices}</p>
            </div>
            ...
            <TableBody>
              {filteredInvoices.map((invoice) => (
                <TableRow key={invoice.id} className="hover:bg-gray-50">
                  ...
                  <TableCell>
                    <div>
                      <p className="text-sm font-medium text-gray-900">{getCustomerName(invoice.customerId)}</p>
                      <p className="text-xs text-gray-500">Customer</p>
                    </div>
                  </TableCell>
                  <TableCell>
                    <div>
                      <p className="text-sm font-medium text-gray-900">{getTicketNumber(invoice.serviceTicketId)}</p>
                      <p className="text-xs text-gray-500">Service Ticket</p>
                    </div>
                  </TableCell>
                  <TableCell>

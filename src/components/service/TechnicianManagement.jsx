import { Award, Clock, Plus, Users } from "lucide-react";
...
export function TechnicianManagement() {
  ...
  const totalTicketsAssigned = serviceTickets.filter(
    (t) => t.assignedTechnician
  ).length;
  const averageRating =
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Manage your service team and their specializations
            </p>
          </div>
          <Button
      ...
      {(searchTerm || statusFilter !== "all") && (
        <div className="text-sm text-gray-600 dark:text-gray-400 px-1">
          Found {filteredTechnicians.length} technician
